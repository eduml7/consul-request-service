...
public class CustomSelf {
		...
		private CustomDebugConfig customDebugConfig;
		
		
		public CustomDebugConfig getCustomDebugConfig() {
			return customDebugConfig;
		}

		public void setCustomDebugConfig(CustomDebugConfig customDebugConfig) {
			this.customDebugConfig = customDebugConfig;
		}
