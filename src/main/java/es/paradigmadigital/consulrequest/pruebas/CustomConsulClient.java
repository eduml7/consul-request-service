 ...
 */
public class CustomConsulClient implements
		AclClient,
		AgentClient,
		CatalogClient,
		CoordinateClient,
	...
	public CustomConsulClient(ConsulRawClient rawClient) {
	 ...
	 */
	public CustomConsulClient(TLSConfig tlsConfig) {
	 ...
	 */
	public CustomConsulClient(String agentHost) {
	 ...
	 * @param tlsConfig TLS configuration
	 */
	public CustomConsulClient(String agentHost, TLSConfig tlsConfig) {
	 ...
	 */
	public CustomConsulClient(String agentHost, int agentPort) {
	 ...
	 * @param tlsConfig TLS configuration
	 */
	public CustomConsulClient(String agentHost, int agentPort, TLSConfig tlsConfig) {
